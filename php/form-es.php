...
echo "<script type='text/javascript'>alert('Su mensaje ha sido enviado con exito');</script>";
echo "<script type='text/javascript'>window.location.href='http://www.balmsadvisory.com';</script>";
